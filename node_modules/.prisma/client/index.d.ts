...
export type Entry = {
  ...
  user_id: string
  company_collaboration_id: number | null
}
...
/**
   ...
   * `prisma.wasteType`: Exposes CRUD operations for the **WasteType** model.
    ...
    * ```
    */
  get wasteType(): Prisma.WasteTypeDelegate<GlobalReject>;
...
export namespace Prisma {
  ...
  */
  ...
  export type WasteTypeCountOutputTypeSelect = {
    entries?: boolean
  }

  export type WasteTypeCountOutputTypeGetPayload<S extends boolean | null | undefined | WasteTypeCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? WasteTypeCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (WasteTypeCountOutputTypeArgs)
    ? WasteTypeCountOutputType 
    : S extends { select: any } & (WasteTypeCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof WasteTypeCountOutputType ? WasteTypeCountOutputType[P] : never
  } 
      : WasteTypeCountOutputType
   ...
   */
  export type WasteTypeCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the WasteTypeCountOutputType
     */
    select?: WasteTypeCountOutputTypeSelect | null
  }
  ...
  /**
   * Count Type CompanyCollaborationCountOutputType
   */


  export type CompanyCollaborationCountOutputType = {
    entries: number
  }

  export type CompanyCollaborationCountOutputTypeSelect = {
    entries?: boolean
  }

  export type CompanyCollaborationCountOutputTypeGetPayload<S extends boolean | null | undefined | CompanyCollaborationCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? CompanyCollaborationCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (CompanyCollaborationCountOutputTypeArgs)
    ? CompanyCollaborationCountOutputType 
    : S extends { select: any } & (CompanyCollaborationCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof CompanyCollaborationCountOutputType ? CompanyCollaborationCountOutputType[P] : never
  } 
      : CompanyCollaborationCountOutputType
  ...
  /**
   * CompanyCollaborationCountOutputType without action
   */
  export type CompanyCollaborationCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the CompanyCollaborationCountOutputType
     */
    select?: CompanyCollaborationCountOutputTypeSelect | null
  }
  ...
  export type WasteTypeAggregateArgs = {
    /**
     ...
     */
    orderBy?: Enumerable<WasteTypeOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
  ...
  export type WasteTypeGroupByArgs = {
    where?: WasteTypeWhereInput
    orderBy?: Enumerable<WasteTypeOrderByWithAggregationInput>
    by: WasteTypeScalarFieldEnum[]
  ...
  type GetWasteTypeGroupByPayload<T extends WasteTypeGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<WasteTypeGroupByOutputType, T['by']> &
        {
  ...
  export type WasteTypeSelect = {
    id?: boolean
    name?: boolean
    entries?: boolean | WasteType$entriesArgs
    _count?: boolean | WasteTypeCountOutputTypeArgs
  }


  export type WasteTypeInclude = {
    entries?: boolean | WasteType$entriesArgs
    _count?: boolean | WasteTypeCountOutputTypeArgs
  }

  export type WasteTypeGetPayload<S extends boolean | null | undefined | WasteTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? WasteType :
    S extends undefined ? never :
    S extends { include: any } & (WasteTypeArgs | WasteTypeFindManyArgs)
    ? WasteType  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'entries' ? Array < EntryGetPayload<S['include'][P]>>  :
        P extends '_count' ? WasteTypeCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (WasteTypeArgs | WasteTypeFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'entries' ? Array < EntryGetPayload<S['select'][P]>>  :
        P extends '_count' ? WasteTypeCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof WasteType ? WasteType[P] : never
  } 
      : WasteType


  type WasteTypeCountArgs = 
    Omit<WasteTypeFindManyArgs, 'select' | 'include'> & {
      select?: WasteTypeCountAggregateInputType | true
    }

  export interface WasteTypeDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
     ...
     * })
    **/
    findUnique<T extends WasteTypeFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, WasteTypeFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'WasteType'> extends True ? Prisma__WasteTypeClient<WasteTypeGetPayload<T>> : Prisma__WasteTypeClient<WasteTypeGetPayload<T> | null, null>
     ...
     * })
    **/
    findUniqueOrThrow<T extends WasteTypeFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, WasteTypeFindUniqueOrThrowArgs>
    ): Prisma__WasteTypeClient<WasteTypeGetPayload<T>>
     ...
     * })
    **/
    findFirst<T extends WasteTypeFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, WasteTypeFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'WasteType'> extends True ? Prisma__WasteTypeClient<WasteTypeGetPayload<T>> : Prisma__WasteTypeClient<WasteTypeGetPayload<T> | null, null>
     ...
     * })
    **/
    findFirstOrThrow<T extends WasteTypeFindFirstOrThrowArgs>(
      args?: SelectSubset<T, WasteTypeFindFirstOrThrowArgs>
    ): Prisma__WasteTypeClient<WasteTypeGetPayload<T>>
     ...
     * 
    **/
    findMany<T extends WasteTypeFindManyArgs>(
      args?: SelectSubset<T, WasteTypeFindManyArgs>
    ): Prisma.PrismaPromise<Array<WasteTypeGetPayload<T>>>
     ...
     * 
    **/
    create<T extends WasteTypeCreateArgs>(
      args: SelectSubset<T, WasteTypeCreateArgs>
    ): Prisma__WasteTypeClient<WasteTypeGetPayload<T>>
     ...
     *     
    **/
    createMany<T extends WasteTypeCreateManyArgs>(
      args?: SelectSubset<T, WasteTypeCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    delete<T extends WasteTypeDeleteArgs>(
      args: SelectSubset<T, WasteTypeDeleteArgs>
    ): Prisma__WasteTypeClient<WasteTypeGetPayload<T>>
     ...
     * 
    **/
    update<T extends WasteTypeUpdateArgs>(
      args: SelectSubset<T, WasteTypeUpdateArgs>
    ): Prisma__WasteTypeClient<WasteTypeGetPayload<T>>
     ...
     * 
    **/
    deleteMany<T extends WasteTypeDeleteManyArgs>(
      args?: SelectSubset<T, WasteTypeDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends WasteTypeUpdateManyArgs>(
      args: SelectSubset<T, WasteTypeUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends WasteTypeUpsertArgs>(
      args: SelectSubset<T, WasteTypeUpsertArgs>
    ): Prisma__WasteTypeClient<WasteTypeGetPayload<T>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__WasteTypeClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
    ...
    entries<T extends WasteType$entriesArgs= {}>(args?: Subset<T, WasteType$entriesArgs>): Prisma.PrismaPromise<Array<EntryGetPayload<T>>| Null>;
  ...
  /**
   * WasteType base type for findUnique actions
   */
  export type WasteTypeFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the WasteType
     */
    select?: WasteTypeSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: WasteTypeInclude | null
    /**
   ...
   */
  export interface WasteTypeFindUniqueArgs extends WasteTypeFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export type WasteTypeFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the WasteType
     */
    select?: WasteTypeSelect | null
  ...
  /**
   * WasteType base type for findFirst actions
   */
  export type WasteTypeFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the WasteType
     */
    select?: WasteTypeSelect | null
     ...
     */
    distinct?: Enumerable<WasteTypeScalarFieldEnum>
  }

  /**
   * WasteType findFirst
   */
  export interface WasteTypeFindFirstArgs extends WasteTypeFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type WasteTypeFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the WasteType
     */
    select?: WasteTypeSelect | null
   ...
   * WasteType findMany
   */
  export type WasteTypeFindManyArgs = {
    /**
     * Select specific fields to fetch from the WasteType
     */
    select?: WasteTypeSelect | null
   ...
   * WasteType create
   */
  export type WasteTypeCreateArgs = {
    /**
     * Select specific fields to fetch from the WasteType
     */
    select?: WasteTypeSelect | null
   ...
   */
  export type WasteTypeCreateManyArgs = {
    /**
     * The data used to create many WasteTypes.
     */
    data: Enumerable<WasteTypeCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   * WasteType update
   */
  export type WasteTypeUpdateArgs = {
    /**
     * Select specific fields to fetch from the WasteType
     */
    select?: WasteTypeSelect | null
   ...
   */
  export type WasteTypeUpdateManyArgs = {
    /**
   ...
   * WasteType upsert
   */
  export type WasteTypeUpsertArgs = {
    /**
     * Select specific fields to fetch from the WasteType
     */
    select?: WasteTypeSelect | null
   ...
   * WasteType delete
   */
  export type WasteTypeDeleteArgs = {
    /**
     * Select specific fields to fetch from the WasteType
     */
    select?: WasteTypeSelect | null
   ...
   */
  export type WasteTypeDeleteManyArgs = {
    /**
   ...
   * WasteType.entries
   */
  export type WasteType$entriesArgs = {
    /**
     * Select specific fields to fetch from the Entry
     */
    select?: EntrySelect | null
  ...
  export type EntryCountAggregateOutputType = {
    ...
    waste_type_id: number
    user_id: number
    company_collaboration_id: number
    _all: number
  }
  ...
  export type EntrySelect = {
    ...
    updated_at?: boolean
    weight?: boolean
    waste_type?: boolean | WasteTypeArgs
    waste_type_id?: boolean
    user?: boolean | UserArgs
    user_id?: boolean
    CompanyCollaboration?: boolean | CompanyCollaborationArgs
    company_collaboration_id?: boolean
  }
  ...
  export type EntryGetPayload<S extends boolean | null | undefined | EntryArgs> =
    ...
    ? Entry  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'waste_type' ? WasteTypeGetPayload<S['include'][P]> :
        P extends 'user' ? UserGetPayload<S['include'][P]> :
        P extends 'CompanyCollaboration' ? CompanyCollaborationGetPayload<S['include'][P]> | null :  never
  } 
    : S extends { select: any } & (EntryArgs | EntryFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'waste_type' ? WasteTypeGetPayload<S['select'][P]> :
        P extends 'user' ? UserGetPayload<S['select'][P]> :
        P extends 'CompanyCollaboration' ? CompanyCollaborationGetPayload<S['select'][P]> | null :  P extends keyof Entry ? Entry[P] : never
  } 
      : Entry
  ...
  export class Prisma__EntryClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    waste_type<T extends WasteTypeArgs= {}>(args?: Subset<T, WasteTypeArgs>): Prisma__WasteTypeClient<WasteTypeGetPayload<T> | Null>;

    user<T extends UserArgs= {}>(args?: Subset<T, UserArgs>): Prisma__UserClient<UserGetPayload<T> | Null>;

    CompanyCollaboration<T extends CompanyCollaborationArgs= {}>(args?: Subset<T, CompanyCollaborationArgs>): Prisma__CompanyCollaborationClient<CompanyCollaborationGetPayload<T> | Null>;
  ...
  export type CompanySelect = {
    ...
    sites?: boolean | Company$sitesArgs
  ...
  export type CompanyGetPayload<S extends boolean | null | undefined | CompanyArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'sites' ? Array < SiteGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'sites' ? Array < SiteGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__CompanyClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    sites<T extends Company$sitesArgs= {}>(args?: Subset<T, Company$sitesArgs>): Prisma.PrismaPromise<Array<SiteGetPayload<T>>| Null>;
  ...
  export type CompanyCollaborationSelect = {
    ...
    entries?: boolean | CompanyCollaboration$entriesArgs
    _count?: boolean | CompanyCollaborationCountOutputTypeArgs
  }
  ...
  export type CompanyCollaborationGetPayload<S extends boolean | null | undefined | CompanyCollaborationArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'collaborator' ? CompanyGetPayload<S['include'][P]> :
        P extends 'entries' ? Array < EntryGetPayload<S['include'][P]>>  :
        P extends '_count' ? CompanyCollaborationCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'collaborator' ? CompanyGetPayload<S['select'][P]> :
        P extends 'entries' ? Array < EntryGetPayload<S['select'][P]>>  :
        P extends '_count' ? CompanyCollaborationCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof CompanyCollaboration ? CompanyCollaboration[P] : never
  } 
      : CompanyCollaboration
  ...
  export class Prisma__CompanyCollaborationClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    entries<T extends CompanyCollaboration$entriesArgs= {}>(args?: Subset<T, CompanyCollaboration$entriesArgs>): Prisma.PrismaPromise<Array<EntryGetPayload<T>>| Null>;
  ...
  /**
   * CompanyCollaboration.entries
   */
  export type CompanyCollaboration$entriesArgs = {
    /**
     * Select specific fields to fetch from the Entry
     */
    select?: EntrySelect | null
  ...
  export type WasteTypeWhereInput = {
    AND?: Enumerable<WasteTypeWhereInput>
    OR?: Enumerable<WasteTypeWhereInput>
    NOT?: Enumerable<WasteTypeWhereInput>
    id?: IntFilter | number
  ...
  export type WasteTypeWhereUniqueInput = {
    id?: number
    name?: string
  }
  ...
  export type WasteTypeScalarWhereWithAggregatesInput = {
    AND?: Enumerable<WasteTypeScalarWhereWithAggregatesInput>
    OR?: Enumerable<WasteTypeScalarWhereWithAggregatesInput>
    NOT?: Enumerable<WasteTypeScalarWhereWithAggregatesInput>
  ...
  export type EntryWhereInput = {
    ...
    waste_type?: XOR<WasteTypeRelationFilter, WasteTypeWhereInput>
    waste_type_id?: IntFilter | number
    user?: XOR<UserRelationFilter, UserWhereInput>
    user_id?: StringFilter | string
    CompanyCollaboration?: XOR<CompanyCollaborationRelationFilter, CompanyCollaborationWhereInput> | null
    company_collaboration_id?: IntNullableFilter | number | null
  }
  ...
  export type EntryOrderByWithRelationInput = {
    ...
    user_id?: SortOrder
    CompanyCollaboration?: CompanyCollaborationOrderByWithRelationInput
    company_collaboration_id?: SortOrder
  }
  ...
  export type EntryScalarWhereWithAggregatesInput = {
    ...
    company_collaboration_id?: IntNullableWithAggregatesFilter | number | null
  }
  ...
  export type testingDataScalarWhereWithAggregatesInput = {
    ...
    id?: IntWithAggregatesFilter | number
    jsonArray?: JsonWithAggregatesFilter
  }
  ...
  export type WasteTypeCreateInput = {
    name: string
    entries?: EntryCreateNestedManyWithoutWaste_typeInput
  }

  export type WasteTypeUncheckedCreateInput = {
    id?: number
    name: string
    entries?: EntryUncheckedCreateNestedManyWithoutWaste_typeInput
  }

  export type WasteTypeUpdateInput = {
    name?: StringFieldUpdateOperationsInput | string
    entries?: EntryUpdateManyWithoutWaste_typeNestedInput
  }

  export type WasteTypeUncheckedUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    entries?: EntryUncheckedUpdateManyWithoutWaste_typeNestedInput
  }
  ...
  export type EntryCreateInput = {
    ...
    weight: number
    waste_type: WasteTypeCreateNestedOneWithoutEntriesInput
    user: UserCreateNestedOneWithoutEntriesInput
    CompanyCollaboration?: CompanyCollaborationCreateNestedOneWithoutEntriesInput
  }
  ...
  export type EntryUpdateInput = {
    ...
    waste_type?: WasteTypeUpdateOneRequiredWithoutEntriesNestedInput
    user?: UserUpdateOneRequiredWithoutEntriesNestedInput
    CompanyCollaboration?: CompanyCollaborationUpdateOneWithoutEntriesNestedInput
  }
  ...
  export type EntryUncheckedUpdateInput = {
    ...
    company_collaboration_id?: NullableIntFieldUpdateOperationsInput | number | null
  }
  ...
  export type CompanyCollaborationCreateInput = {
    ...
    entries?: EntryCreateNestedManyWithoutCompanyCollaborationInput
  }
  ...
  export type CompanyCollaborationUncheckedCreateInput = {
    ...
    source_id: number
    collaborator_id: number
    entries?: EntryUncheckedCreateNestedManyWithoutCompanyCollaborationInput
  }
  ...
  export type CompanyCollaborationUpdateInput = {
    ...
    entries?: EntryUpdateManyWithoutCompanyCollaborationNestedInput
  }
  ...
  export type CompanyCollaborationUncheckedUpdateInput = {
    ...
    entries?: EntryUncheckedUpdateManyWithoutCompanyCollaborationNestedInput
  }
  ...
  export type testingDataCreateInput = {
    jsonArray: JsonNullValueInput | InputJsonValue
  }
  ...
  export type WasteTypeRelationFilter = {
  ...
  export type CompanyCollaborationRelationFilter = {
    is?: CompanyCollaborationWhereInput | null
    isNot?: CompanyCollaborationWhereInput | null
  }
  ...
  export type EntryCreateNestedManyWithoutWaste_typeInput = {
    create?: XOR<Enumerable<EntryCreateWithoutWaste_typeInput>, Enumerable<EntryUncheckedCreateWithoutWaste_typeInput>>
    connectOrCreate?: Enumerable<EntryCreateOrConnectWithoutWaste_typeInput>
    createMany?: EntryCreateManyWaste_typeInputEnvelope
    connect?: Enumerable<EntryWhereUniqueInput>
  }

  export type EntryUncheckedCreateNestedManyWithoutWaste_typeInput = {
    create?: XOR<Enumerable<EntryCreateWithoutWaste_typeInput>, Enumerable<EntryUncheckedCreateWithoutWaste_typeInput>>
    connectOrCreate?: Enumerable<EntryCreateOrConnectWithoutWaste_typeInput>
    createMany?: EntryCreateManyWaste_typeInputEnvelope
    connect?: Enumerable<EntryWhereUniqueInput>
  ...
  export type EntryUpdateManyWithoutWaste_typeNestedInput = {
    create?: XOR<Enumerable<EntryCreateWithoutWaste_typeInput>, Enumerable<EntryUncheckedCreateWithoutWaste_typeInput>>
    connectOrCreate?: Enumerable<EntryCreateOrConnectWithoutWaste_typeInput>
    upsert?: Enumerable<EntryUpsertWithWhereUniqueWithoutWaste_typeInput>
    createMany?: EntryCreateManyWaste_typeInputEnvelope
    set?: Enumerable<EntryWhereUniqueInput>
    disconnect?: Enumerable<EntryWhereUniqueInput>
    delete?: Enumerable<EntryWhereUniqueInput>
    connect?: Enumerable<EntryWhereUniqueInput>
    update?: Enumerable<EntryUpdateWithWhereUniqueWithoutWaste_typeInput>
    updateMany?: Enumerable<EntryUpdateManyWithWhereWithoutWaste_typeInput>
    deleteMany?: Enumerable<EntryScalarWhereInput>
  }
  ...
  export type EntryUncheckedUpdateManyWithoutWaste_typeNestedInput = {
    create?: XOR<Enumerable<EntryCreateWithoutWaste_typeInput>, Enumerable<EntryUncheckedCreateWithoutWaste_typeInput>>
    connectOrCreate?: Enumerable<EntryCreateOrConnectWithoutWaste_typeInput>
    upsert?: Enumerable<EntryUpsertWithWhereUniqueWithoutWaste_typeInput>
    createMany?: EntryCreateManyWaste_typeInputEnvelope
  ...
  export type WasteTypeCreateNestedOneWithoutEntriesInput = {
    create?: XOR<WasteTypeCreateWithoutEntriesInput, WasteTypeUncheckedCreateWithoutEntriesInput>
    connectOrCreate?: WasteTypeCreateOrConnectWithoutEntriesInput
  ...
  export type CompanyCollaborationCreateNestedOneWithoutEntriesInput = {
    create?: XOR<CompanyCollaborationCreateWithoutEntriesInput, CompanyCollaborationUncheckedCreateWithoutEntriesInput>
    connectOrCreate?: CompanyCollaborationCreateOrConnectWithoutEntriesInput
    connect?: CompanyCollaborationWhereUniqueInput
  }
  ...
  export type WasteTypeUpdateOneRequiredWithoutEntriesNestedInput = {
    create?: XOR<WasteTypeCreateWithoutEntriesInput, WasteTypeUncheckedCreateWithoutEntriesInput>
    connectOrCreate?: WasteTypeCreateOrConnectWithoutEntriesInput
    upsert?: WasteTypeUpsertWithoutEntriesInput
    connect?: WasteTypeWhereUniqueInput
    update?: XOR<WasteTypeUpdateWithoutEntriesInput, WasteTypeUncheckedUpdateWithoutEntriesInput>
  }
  ...
  export type CompanyCollaborationUpdateOneWithoutEntriesNestedInput = {
    create?: XOR<CompanyCollaborationCreateWithoutEntriesInput, CompanyCollaborationUncheckedCreateWithoutEntriesInput>
    connectOrCreate?: CompanyCollaborationCreateOrConnectWithoutEntriesInput
    upsert?: CompanyCollaborationUpsertWithoutEntriesInput
    disconnect?: boolean
    delete?: boolean
    connect?: CompanyCollaborationWhereUniqueInput
    update?: XOR<CompanyCollaborationUpdateWithoutEntriesInput, CompanyCollaborationUncheckedUpdateWithoutEntriesInput>
  }
  ...
  export type EntryCreateNestedManyWithoutCompanyCollaborationInput = {
    create?: XOR<Enumerable<EntryCreateWithoutCompanyCollaborationInput>, Enumerable<EntryUncheckedCreateWithoutCompanyCollaborationInput>>
    connectOrCreate?: Enumerable<EntryCreateOrConnectWithoutCompanyCollaborationInput>
    createMany?: EntryCreateManyCompanyCollaborationInputEnvelope
    connect?: Enumerable<EntryWhereUniqueInput>
  }

  export type EntryUncheckedCreateNestedManyWithoutCompanyCollaborationInput = {
    create?: XOR<Enumerable<EntryCreateWithoutCompanyCollaborationInput>, Enumerable<EntryUncheckedCreateWithoutCompanyCollaborationInput>>
    connectOrCreate?: Enumerable<EntryCreateOrConnectWithoutCompanyCollaborationInput>
    createMany?: EntryCreateManyCompanyCollaborationInputEnvelope
    connect?: Enumerable<EntryWhereUniqueInput>
  ...
  export type EntryUpdateManyWithoutCompanyCollaborationNestedInput = {
    create?: XOR<Enumerable<EntryCreateWithoutCompanyCollaborationInput>, Enumerable<EntryUncheckedCreateWithoutCompanyCollaborationInput>>
    connectOrCreate?: Enumerable<EntryCreateOrConnectWithoutCompanyCollaborationInput>
    upsert?: Enumerable<EntryUpsertWithWhereUniqueWithoutCompanyCollaborationInput>
    createMany?: EntryCreateManyCompanyCollaborationInputEnvelope
    set?: Enumerable<EntryWhereUniqueInput>
    disconnect?: Enumerable<EntryWhereUniqueInput>
    delete?: Enumerable<EntryWhereUniqueInput>
    connect?: Enumerable<EntryWhereUniqueInput>
    update?: Enumerable<EntryUpdateWithWhereUniqueWithoutCompanyCollaborationInput>
    updateMany?: Enumerable<EntryUpdateManyWithWhereWithoutCompanyCollaborationInput>
    deleteMany?: Enumerable<EntryScalarWhereInput>
  }

  export type EntryUncheckedUpdateManyWithoutCompanyCollaborationNestedInput = {
    create?: XOR<Enumerable<EntryCreateWithoutCompanyCollaborationInput>, Enumerable<EntryUncheckedCreateWithoutCompanyCollaborationInput>>
    connectOrCreate?: Enumerable<EntryCreateOrConnectWithoutCompanyCollaborationInput>
    upsert?: Enumerable<EntryUpsertWithWhereUniqueWithoutCompanyCollaborationInput>
    createMany?: EntryCreateManyCompanyCollaborationInputEnvelope
  ...
  export type EntryCreateWithoutWaste_typeInput = {
    waste: string
    site: string
    collaborator: string
    created_at?: Date | string
  ...
  export type EntryUncheckedCreateWithoutWaste_typeInput = {
    id?: number
    waste: string
    site: string
    collaborator: string
  ...
  export type EntryCreateOrConnectWithoutWaste_typeInput = {
    where: EntryWhereUniqueInput
    create: XOR<EntryCreateWithoutWaste_typeInput, EntryUncheckedCreateWithoutWaste_typeInput>
  }

  export type EntryCreateManyWaste_typeInputEnvelope = {
    data: Enumerable<EntryCreateManyWaste_typeInput>
    skipDuplicates?: boolean
  }

  export type EntryUpsertWithWhereUniqueWithoutWaste_typeInput = {
    where: EntryWhereUniqueInput
    update: XOR<EntryUpdateWithoutWaste_typeInput, EntryUncheckedUpdateWithoutWaste_typeInput>
    create: XOR<EntryCreateWithoutWaste_typeInput, EntryUncheckedCreateWithoutWaste_typeInput>
  }

  export type EntryUpdateWithWhereUniqueWithoutWaste_typeInput = {
    where: EntryWhereUniqueInput
    data: XOR<EntryUpdateWithoutWaste_typeInput, EntryUncheckedUpdateWithoutWaste_typeInput>
  }

  export type EntryUpdateManyWithWhereWithoutWaste_typeInput = {
    where: EntryScalarWhereInput
    data: XOR<EntryUpdateManyMutationInput, EntryUncheckedUpdateManyWithoutEntriesInput>
  }

  export type WasteTypeCreateWithoutEntriesInput = {
    name: string
  }

  export type WasteTypeUncheckedCreateWithoutEntriesInput = {
    id?: number
    name: string
  }

  export type WasteTypeCreateOrConnectWithoutEntriesInput = {
    where: WasteTypeWhereUniqueInput
    create: XOR<WasteTypeCreateWithoutEntriesInput, WasteTypeUncheckedCreateWithoutEntriesInput>
  }
  ...
  export type CompanyCollaborationCreateWithoutEntriesInput = {
    company: CompanyCreateNestedOneWithoutCollector_companyInput
    collaborator: CompanyCreateNestedOneWithoutSource_companyInput
  }

  export type CompanyCollaborationUncheckedCreateWithoutEntriesInput = {
    id?: number
    source_id: number
    collaborator_id: number
  }

  export type CompanyCollaborationCreateOrConnectWithoutEntriesInput = {
    where: CompanyCollaborationWhereUniqueInput
    create: XOR<CompanyCollaborationCreateWithoutEntriesInput, CompanyCollaborationUncheckedCreateWithoutEntriesInput>
  }

  export type WasteTypeUpsertWithoutEntriesInput = {
    update: XOR<WasteTypeUpdateWithoutEntriesInput, WasteTypeUncheckedUpdateWithoutEntriesInput>
    create: XOR<WasteTypeCreateWithoutEntriesInput, WasteTypeUncheckedCreateWithoutEntriesInput>
  }

  export type WasteTypeUpdateWithoutEntriesInput = {
    name?: StringFieldUpdateOperationsInput | string
  }

  export type WasteTypeUncheckedUpdateWithoutEntriesInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
  }
  ...
  export type CompanyCollaborationUpsertWithoutEntriesInput = {
    update: XOR<CompanyCollaborationUpdateWithoutEntriesInput, CompanyCollaborationUncheckedUpdateWithoutEntriesInput>
    create: XOR<CompanyCollaborationCreateWithoutEntriesInput, CompanyCollaborationUncheckedCreateWithoutEntriesInput>
  }

  export type CompanyCollaborationUpdateWithoutEntriesInput = {
    company?: CompanyUpdateOneRequiredWithoutCollector_companyNestedInput
    collaborator?: CompanyUpdateOneRequiredWithoutSource_companyNestedInput
  }

  export type CompanyCollaborationUncheckedUpdateWithoutEntriesInput = {
    id?: IntFieldUpdateOperationsInput | number
    source_id?: IntFieldUpdateOperationsInput | number
    collaborator_id?: IntFieldUpdateOperationsInput | number
  }
  ...
  export type EntryCreateWithoutCompanyCollaborationInput = {
    waste: string
    site: string
    collaborator: string
    created_at?: Date | string
  ...
  export type EntryUncheckedCreateWithoutCompanyCollaborationInput = {
    id?: number
    waste: string
    site: string
    collaborator: string
  ...
  export type EntryCreateOrConnectWithoutCompanyCollaborationInput = {
    where: EntryWhereUniqueInput
    create: XOR<EntryCreateWithoutCompanyCollaborationInput, EntryUncheckedCreateWithoutCompanyCollaborationInput>
  }

  export type EntryCreateManyCompanyCollaborationInputEnvelope = {
    data: Enumerable<EntryCreateManyCompanyCollaborationInput>
    skipDuplicates?: boolean
  }
  ...
  export type EntryUpsertWithWhereUniqueWithoutCompanyCollaborationInput = {
    where: EntryWhereUniqueInput
    update: XOR<EntryUpdateWithoutCompanyCollaborationInput, EntryUncheckedUpdateWithoutCompanyCollaborationInput>
    create: XOR<EntryCreateWithoutCompanyCollaborationInput, EntryUncheckedCreateWithoutCompanyCollaborationInput>
  }

  export type EntryUpdateWithWhereUniqueWithoutCompanyCollaborationInput = {
    where: EntryWhereUniqueInput
    data: XOR<EntryUpdateWithoutCompanyCollaborationInput, EntryUncheckedUpdateWithoutCompanyCollaborationInput>
  }

  export type EntryUpdateManyWithWhereWithoutCompanyCollaborationInput = {
    where: EntryScalarWhereInput
    data: XOR<EntryUpdateManyMutationInput, EntryUncheckedUpdateManyWithoutEntriesInput>
  }
  ...
  export type EntryCreateManyWaste_typeInput = {
    id?: number
    waste: string
    site: string
    collaborator: string
  ...
  export type EntryUpdateWithoutWaste_typeInput = {
    waste?: StringFieldUpdateOperationsInput | string
    site?: StringFieldUpdateOperationsInput | string
    collaborator?: StringFieldUpdateOperationsInput | string
    created_at?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type EntryUncheckedUpdateWithoutWaste_typeInput = {
    id?: IntFieldUpdateOperationsInput | number
    waste?: StringFieldUpdateOperationsInput | string
    site?: StringFieldUpdateOperationsInput | string
    collaborator?: StringFieldUpdateOperationsInput | string
  ...
  export type EntryCreateManyCompanyCollaborationInput = {
    id?: number
    waste: string
    site: string
    collaborator: string
  ...
  export type EntryUpdateWithoutCompanyCollaborationInput = {
    waste?: StringFieldUpdateOperationsInput | string
    site?: StringFieldUpdateOperationsInput | string
    collaborator?: StringFieldUpdateOperationsInput | string
    created_at?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type EntryUncheckedUpdateWithoutCompanyCollaborationInput = {
    id?: IntFieldUpdateOperationsInput | number
    waste?: StringFieldUpdateOperationsInput | string
    site?: StringFieldUpdateOperationsInput | string
    collaborator?: StringFieldUpdateOperationsInput | string
